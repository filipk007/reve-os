      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-medium rounded-xl px-4 py-3 text-sm hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
    ...
    <Suspense
      fallback={
        <div className="min-h-screen bg-clay-950 flex items-center justify-center">
          <p className="text-clay-300">Loading...</p>
        </div>
      }
    >
      <LoginForm />
