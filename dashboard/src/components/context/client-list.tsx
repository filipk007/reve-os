      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((client) => (
            <Card
              key={client.slug}
              className="bg-clay-900 border-clay-800 p-4 hover:border-clay-700 transition-colors"
            >
              <div className="flex items-start justify-between mb-3">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-clay-500 font-mono">{client.slug}</p>
                </div>
                <div className="flex gap-1 shrink-0 ml-2">
                  ...
                  <Button
                    ...
                    className="text-clay-400 hover:text-kiln-coral"
                  >
              ...
              {client.domain && (
                <div className="flex items-center gap-1.5 mt-3 text-xs text-clay-500">
