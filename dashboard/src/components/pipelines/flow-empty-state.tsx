...
export function FlowEmptyState() {
  return (
    <motion.div
      ...
      className="rounded-xl border-2 border-dashed border-clay-500 p-12 text-center"
    >
      <div className="flex flex-col items-center gap-4">
        {/* Faded connector illustration */}
        <div className="flex flex-col items-center gap-1 opacity-30">
          <div className="h-10 w-48 rounded-lg border border-clay-700 bg-clay-800" />
        ...
        <div className="mt-2">
          <Workflow className="h-6 w-6 text-clay-300 mx-auto mb-2" />
